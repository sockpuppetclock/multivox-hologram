...
void graphics_draw_triangle(pixel_t* volume, const float* v0, const float* v1, const float* v2, pixel_t colour, const float* t0, const float* t1, const float* t2, struct image_s* texture);
